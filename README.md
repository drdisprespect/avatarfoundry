...
A sophisticated, Azure Foundry Agent , real-time AI chat application built with Next.js and Azure OpenAI services, featuring voice interaction, intelligent search capabilities, and a modern, responsive UI.
